...
\resumeSubHeadingListStart
  ...
  \normalsize
  \resumeSubheading
    {Lecturer/Instructor}{Aug. 2025 -- Present}
    {University of Oklahoma}{}

    \begin{itemize}
      \small
      \setlength\itemsep{0pt}
      \item Act as instructor of record for courses in both Physics and
        Mathematics, adapting instruction to diverse student backgrounds and
        academic goals.
      \item Independently design and manage a full course, developing
        instructional materials and assessments while integrating advanced
        content in Python programming and data analysis.
      \item Collaborate within a multi-instructor team to coordinate
        curriculum, align objectives, and ensure consistency across course
        sections.
    \end{itemize}
  \vspace{-5pt}
  ...
  \normalsize
  \resumeSubheading
    {Generative AI Trainer}{Dec. 2024 -- Aug. 2025}
...
{Python, C/C++, SQL, Make/CMake, Bash, Fortran, Slurm, \LaTeX}

\technology{Python Libraries}
{NumPy, pandas, scikit-learn, PyTorch, matplotlib, SciPy}

\technology{Version Control}
{Git, CI/CD with GitHub Actions workflows}
...
\resumeSubHeadingListStart
  ...
  \item \href{https://anthonyburrow.github.io/projects/SNIaSpectrumNN}{SNIaSpectrumNN} (Python):
    Neural network models made with PyTorch for predicting observational
    properties of astronomical objects based on their spectra.

  \item \href{https://anthonyburrow.github.io/projects/SNEx}{SNEx} (Python):
    Spectrum extrapolation into near-infrared wavelengths using principal
    component analysis.

  \item \href{https://anthonyburrow.github.io/projects/Spextractor}{Spextractor} (Python):
    Fast spectrum-smoothing by implementing interpolation using models such as
    Gaussian processes and splines.

  \item \href{https://github.com/anthonyburrow/SpecFit}{SpecFit} (C++, Python):
    Efficient spectrum-fitting of various integrated models using non-linear
    optimization, utilizing \texttt{pybind11} to enhance performance.

  \item \href{https://anthonyburrow.github.io/projects/Rad1D}{Rad1D} (C++, Python):
  ...
  \item \href{https://anthonyburrow.github.io/projects/Hydro1D}{Hydro1D} (C++, Python):
...
\resumeSubHeadingListStart
  ...
  \item Eight co-authored publications
    ...
    %       {view NASA ADS query})
    of scientific analyses with collaborators.
